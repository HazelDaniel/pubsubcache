...
GlobalRouteCache.configureGlobalCache = (func) => __awaiter(void 0, void 0, void 0, function* () {
    yield _a.channel.cache.cleanup();
    _a.channel.cache = func();
});
GlobalRouteCache.configureGlobalCacheDeserializer = (func) => {
    _a.deserializer = func;
};
GlobalRouteCache.configureGlobalCacheSerializer = (func) => {
    _a.serializer = func;
};
